...
def build_scpc_flowsheet(m, include_concrete_tes=True):
    """
    This function builds an instance of the SCPC flowsheet
    """
    ...
    # Add turbine stages
    m.fs.turbine = HelmTurbineStage(m.fs.set_turbines, default={
        "property_package": m.fs.prop_water_mix})
    ...
    m.fs.t_splitter = HelmSplitter(m.fs.set_t_splitters,
                                   default={"property_package": m.fs.prop_water_mix,
                                            "num_outlets": 2},
                                   # Set the number of outlets for splitter 4
                                   initialize={4: {"property_package": m.fs.prop_water_mix,
                                                   "num_outlets": 3}})
    ...
    m.fs.fwh = HeatExchanger(m.fs.set_fwh, default={
        "delta_temperature_callback": delta_temperature_underwood_callback,
        "shell": {"property_package": m.fs.prop_water_mix,
                  "material_balance_type": MaterialBalanceType.componentTotal,
                  "has_pressure_change": True},
        "tube": {"property_package": m.fs.prop_water_mix,
                 "material_balance_type": MaterialBalanceType.componentTotal,
                 "has_pressure_change": True}})
    ...
    m.fs.fwh_mix = Mixer(m.fs.set_fwh_mix,
                         default={
...
def append_tes_unit_models(m):
    ...
    data1 = {
        ...
        "concrete_density": 2150,
        "concrete_specific_heat": 1000}
...
def fix_dof_and_initialize(m, outlvl=idaeslog.INFO_HIGH, operating_mode="charge"):
    ...
    fwh_mix_drain_state = {1: {"flow": 1434 * 1.1, "pressure": 14617, "enthalpy": 3990},
